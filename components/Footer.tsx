    ...
    <footer className="bg-gray-900 py-8">
      <div className="container flex sm:justify-between justify-center items-center gap-5 max-sm:flex-col">
        ...
        <div className="flex items-center space-x-4">
          <a href="https://x.com/RahulBandekar38" className="flex items-center justify-center w-12 h-12 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
            <svg
              viewBox="0 0 512 512"
              height="1.7em"
          ...
          <a href="https://www.linkedin.com/in/rahul-bandekar-740801248/" className="flex items-center justify-center w-12 h-12 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a href="mailto:rahulbandekar12@gmail.com" className="flex items-center justify-center w-12 h-12 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
          ...
          <a href="https://github.com/rahulbandekar" className="flex items-center justify-center w-12 h-12 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
